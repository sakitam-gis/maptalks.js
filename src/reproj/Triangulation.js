...
class Triangulation {
    /**
     * @param {sourceProj} sourceProj Source projection.
     * @param {targetProj} targetProj Target projection.
    ...
    constructor(sourceProj, targetProj, targetExtent, maxSourceExtent, errorThreshold) {
        ...
        this.transformInv_ = function (c) {
            ...
            if (!transformInvCache[key]) {
                // sourceProj: 源投影；targetProj：目标投影
                transformInvCache[key] = proj4(sourceProj, targetProj, c);
            }
