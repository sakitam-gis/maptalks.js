...
import { getPointResolution } from './proj';

/**
 * Solves system of linear equations using Gaussian elimination method.
 * @param {Array<Array<number>>} mat Augmented matrix (n x n + 1 column) in row-major order.
...
export function calculateSourceResolution(sourceProj, targetProj,
    ...
    const sourceCenter = proj4(sourceProj, targetProj, targetCenter);
 ...
 * @param {boolean=} opt_renderEdges Render reprojection edges. 绘制重投影编译
